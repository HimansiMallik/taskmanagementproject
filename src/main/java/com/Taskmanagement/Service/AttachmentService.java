...
public class AttachmentService {
	...
	public Attachment uploadFile(Long issue,MultipartFile file, String uploadBy) throws FileUploadException, ValidationException {
		...
		try {
			...
			uploadOptions.put("resource-type", "auto");
			@SuppressWarnings("unchecked")
			Map<String, Object> uploadResults =
			        (Map<String, Object>) cloudinary.uploader().upload(file.getBytes(), uploadOptions);			
			...
			attach.setCloudId(uploadResults.get("public_Id").toString());
